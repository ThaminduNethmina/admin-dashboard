...
function BoxWrapper({ children, name }) {
    return (
        <div className="bg-gradient-to-br from-sky-950 to-slate-950 rounded-lg flex-1 flex flex-col  border border-sky-950 p-2 transition ease-out duration-300 hover:scale-105 hover:shadow-inner  hover:shadow-sky-100">
